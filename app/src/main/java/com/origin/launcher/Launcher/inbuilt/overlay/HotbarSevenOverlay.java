...
public class HotbarSevenOverlay extends BaseOverlayButton {
    ...
    public HotbarSevenOverlay(Activity activity) {
        super(activity);
    }

    @Override
    protected String getModId() {
        return ModIds.HOTBAR_SEVEN;
    }

    @Override
    protected int getIconResource() {
        return R.drawable.ic_hotbar_seven_selector;
    }
