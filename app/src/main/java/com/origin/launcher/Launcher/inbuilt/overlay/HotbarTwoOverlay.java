...
public class HotbarTwoOverlay extends BaseOverlayButton {
    ...
    public HotbarTwoOverlay(Activity activity) {
        super(activity);
    }

    @Override
    protected String getModId() {
        return ModIds.HOTBAR_TWO;
    }

    @Override
    protected int getIconResource() {
        return R.drawable.ic_hotbar_two_selector;
    }
