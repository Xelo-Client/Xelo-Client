...
public class HotbarFourOverlay extends BaseOverlayButton {
    ...
    public HotbarFourOverlay(Activity activity) {
        super(activity);
    }

    @Override
    protected String getModId() {
        return ModIds.HOTBAR_FOUR;
    }

    @Override
    protected int getIconResource() {
        return R.drawable.ic_hotbar_four_selector;
    }
